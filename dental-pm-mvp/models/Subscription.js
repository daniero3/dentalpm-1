...
Subscription.getPlanConfig = function(plan) {
  const plans = {
    ESSENTIAL: {
      name: 'Essential',
      name_fr: 'Essentiel',
      price_monthly_mga: 149000,
      price_quarterly_mga: 402300,
      price_yearly_mga: 1490000,
      max_users: 3,
      max_patients: 100,
      max_storage_mb: 1000,
      features: {
    ...
    PRO: {
      ...
      price_monthly_mga: 199000,
      price_quarterly_mga: 537300,
      price_yearly_mga: 1990000,
      max_users: 10,
      max_patients: 500,
      max_storage_mb: 5000,
      features: {
    ...
    GROUP: {
      name: 'Group',
      name_fr: 'Groupe',
      price_monthly_mga: 299000,
      price_quarterly_mga: 807300,
      price_yearly_mga: 2990000,
      max_users: 50,
      max_patients: 2000,
