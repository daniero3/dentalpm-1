...
class ToothPosition(str, Enum):
    ...
    TOOTH_1 = "18"   # Upper right wisdom
    TOOTH_2 = "17"   # Upper right molar
    TOOTH_3 = "16"   # Upper right molar
    TOOTH_4 = "15"   # Upper right premolar
    TOOTH_5 = "14"   # Upper right premolar
    TOOTH_6 = "13"   # Upper right canine
    TOOTH_7 = "12"   # Upper right lateral incisor
    TOOTH_8 = "11"   # Upper right central incisor
    TOOTH_9 = "21"   # Upper left central incisor
    TOOTH_10 = "22" # Upper left lateral incisor
    TOOTH_11 = "23" # Upper left canine
    TOOTH_12 = "24" # Upper left premolar
    TOOTH_13 = "25" # Upper left premolar
    TOOTH_14 = "26" # Upper left molar
    TOOTH_15 = "27" # Upper left molar
    TOOTH_16 = "28" # Upper left wisdom
    TOOTH_17 = "38" # Lower left wisdom
    TOOTH_18 = "37" # Lower left molar
    TOOTH_19 = "36" # Lower left molar
    TOOTH_20 = "35" # Lower left premolar
    TOOTH_21 = "34" # Lower left premolar
    TOOTH_22 = "33" # Lower left canine
    TOOTH_23 = "32" # Lower left lateral incisor
    TOOTH_24 = "31" # Lower left central incisor
    TOOTH_25 = "41" # Lower right central incisor
    TOOTH_26 = "42" # Lower right lateral incisor
    TOOTH_27 = "43" # Lower right canine
    TOOTH_28 = "44" # Lower right premolar
    TOOTH_29 = "45" # Lower right premolar
    TOOTH_30 = "46" # Lower right molar
    TOOTH_31 = "47" # Lower right molar
    TOOTH_32 = "48" # Lower right wisdom
